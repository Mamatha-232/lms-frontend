...
export const users = [
  { id: 'u1', name: 'John Doe', role: 'student', email: 'john@domain.com' },
  { id: 'u2', name: 'Sarah Lee', role: 'teacher', email: 'sarah@domain.com' },
  { id: 'u3', name: 'Admin', role: 'admin', email: 'admin@mrms.com' },
];
